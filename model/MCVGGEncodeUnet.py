...
class VGG_M_Block(nn.Module):

    def __init__(self, inplanes, planes, downsample=None):
        super(VGG_M_Block, self).__init__()
        self.conv3_1 = conv3x3(inplanes, planes)
        ...
        self.conv5_1 = conv5x5(inplanes, planes)
...
def make_layers(cfg, batch_norm=False, shrink=4):
    ...
    for v in cfg:
        if v == 'M':
            ...
            conv2d = VGG_M_Block(in_channels, int(v / shrink))
            if batch_norm:
